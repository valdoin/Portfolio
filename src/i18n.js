...
const messages = {
  en: {
    ...
    aboutSecondParagraph:
      "I'm a passionate full-stack web/mobile developer currently studying in Lyon, France.",
    aboutThirdParagraph:
    ...
    aboutFourthParagraph:
      "When I'm not coding, you might find me playing video games or noodling around on the piano.",
    aboutFifthParagraph:
  ...
  fr: {
    ...
    aboutSecondParagraph:
      "Je suis un développeur web/mobile full-stack passionné, étudiant à l'IUT de Lyon 1. ",
    aboutThirdParagraph:
    ...
    aboutFourthParagraph:
      "Je m'occupe également en jouant à des jeux vidéos ou en tapotant sur mon piano.",
    aboutFifthParagraph:
